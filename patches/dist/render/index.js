...
function renderExpanded(ctx, terminalWidth = null) {
    ...
    // Git files line disabled — aggregate file counts already shown inline in the project line.
...
export function render(ctx) {
    ...
    if (lineLayout === 'expanded') {
        ...
        // Session token usage merged into identity line (line 2). Separate line disabled.
